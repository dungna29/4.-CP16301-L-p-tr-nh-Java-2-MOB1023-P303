 ...
 * @author DungNAPC
 */
public class S4_JFrame_Login extends javax.swing.JFrame {

    /**
     * Creates new form S4_JFrame_Login
     */
    public S4_JFrame_Login() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(S4_JFrame_Login.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new S4_JFrame_Login().setVisible(true);
            }
        });
    }
