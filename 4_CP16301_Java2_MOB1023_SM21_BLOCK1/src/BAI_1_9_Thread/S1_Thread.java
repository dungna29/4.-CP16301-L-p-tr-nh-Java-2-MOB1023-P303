...
public class S1_Thread {
    public static void main(String[] args) {
       /*
        ...
        ❖Sheet2
        ❖Sheet3
        + Khi duyệt 1 trang web, có rất nhiều hình ảnh, CSS, javascript… 
        được tải đồng thời bởi các luồng khác nhau.
        ...
        Có 2 cách để tạo lớp Theard mới
        1. kế thừa từ Class Thread
        2. Thực thi interface
