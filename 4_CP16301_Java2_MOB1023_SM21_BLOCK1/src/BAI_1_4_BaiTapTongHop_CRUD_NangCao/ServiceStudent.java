...
public class ServiceStudent {
    ...
    public String removeStudent(String msv) {
     ...
     public String addStudentSql(List<Student> lstStudent) {
       System.out.println(lstStudent.size() + "Service");
         _lstStudents = new ArrayList<>();
         
        _lstStudents.addAll(lstStudent);
    ...
    public int getIndexStudent(String msv) {
     ...
     public int getIndexStudentByList(String msv,List<Student> lstTemp) {
        for (int i = 0; i < lstTemp.size(); i++) {
            if (lstTemp.get(i).getMsv().equals(msv)) {
                return i;
            }
        }
        return -1;
